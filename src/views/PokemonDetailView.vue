<template>
  <div class="flex h-full flex-col">
    ...
    />
    <main class="flex flex-1 flex-col bg-opacity-80" :class="cardColor">
      <section class="flex flex-1 flex-col px-default text-white">
      ...
      <section class="h-72 rounded-t-3xl border bg-white"></section>
    </main>
  </div>
</template>
